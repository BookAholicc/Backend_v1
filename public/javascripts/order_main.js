...
function showOrdersList() {
    ...
    for (var i = 0; i < orders.length; i++) {
        ...
        $('#order_list_root').append(
            '<div class = "order_details mdl-card mdl-shadow--4dp"><div class="mdl-card__title show_products"><h2 class="mdl-card__title-text">'+orders[i].firstName + ' ' + orders[i].lastName+' (User ID: '+orders[i].userId+') &nbsp;</h2><span style="color: white; background-color: blue; padding: 5px; border-radius: 1em; text-align: center;">See Products</span></div><div class="ordered" style="padding: 20px;"><h4>Products Ordered</h4><div style="overflow-x: auto;">'+products_ordered+'</div></div><div style="clear: both; margin: 10px; font-size: 1.2em;">Total Amount: '+orders[i].amount+'</div></div>'
        );
    }
    test();
}
